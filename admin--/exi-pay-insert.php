...
<div class="container-fluid ">
    <div class="row">
        <div class="p-3 mb-2 col bg-secondary">
            <h1 class="display-6">รายการปิดบัญชีสัจจะ </h1>
            <?php
            ...
            <div class="form-group">
                ...
                <form method="POST" action="wit-pay-add.php">
                    <div class="form-group">
                        ...
                        <!-- <input class="form-control " type="text" value="เงินฝากเพื่อนช่วยเพื่อน : <?php echo number_format($ShowAmount2, 2); ?>" disabled> -->
                        <br>
                        <label>ปิดบัญชีเงินสัจจะ</label>
                        <input class="form-control " type="number" name="Amount1" value="<?php echo $ShowAmount1; ?>" max="<?php echo $maxValue; ?>" style="font-size:30px; text-align:right" <?php if ($ShowAmount1 < 600) {
                                                                                                                                                                                                    echo "disabled";
                                                                                                                                                                                                } ?> required>
                        ...
                        <div class="from-group">
                            <label>กรอกรหัสสมาชิกที่ต้องการถอน</label> <span class="text-danger"><?php echo $IDMember; ?></span>
                            <select class="form-control " name="Comment">
                                <option value="เป็นสมาชิก">เลือกรายการ</option>
                                <option value="ลาออก">ลาออกจากสมาชิก</option>
                            </select>
                        </div>
                        <br>
                        <input type="submit" class="form-control btn-secondary " value="ปิดบัญชีสมาชิก">
                        <?php
                        // }
                        ?>
                    </div>
